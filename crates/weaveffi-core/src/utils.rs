//! Shared text helpers for the generators: the standard generated-file
//! prelude/trailer and cross-module type-name resolution.
//!
...
//! them keeps the banner and the dotted-path flattening identical across all
